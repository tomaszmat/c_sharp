...
void PE_low_level_init(void)
{
  ...
  /* TSCR2: TOI=0,TCRE=1,PR2=0,PR1=0,PR0=0 */
  clrSetReg8Bits(TSCR2, 0x87U, 0x08U);  
  ...
  /* ### MC9S12NE64_112 "Cpu" init code ... */
  /* ### BitIO "sw1" init code ... */
  /* ### TimerInt "PWMtimer" init code ... */
  /* TC4: BIT15=0,BIT14=0,BIT13=0,BIT12=0,BIT11=0,BIT10=0,BIT9=0,BIT8=0,BIT7=1,BIT6=1,BIT5=1,BIT4=1,BIT3=1,BIT2=0,BIT1=0,BIT0=1 */
  setReg16(TC4, 0xF9U);                /* Store given value to the compare register */ 
  /* TC7: BIT15=0,BIT14=0,BIT13=0,BIT12=0,BIT11=0,BIT10=0,BIT9=0,BIT8=0,BIT7=1,BIT6=1,BIT5=1,BIT4=1,BIT3=1,BIT2=0,BIT1=0,BIT0=1 */
  setReg16(TC7, 0xF9U);                /* Store given value to the modulo register */ 
  /* ### BitsIO "leds" init code ... */
  /* ### Init_SCI "SCI2" init code ... */
  SCI2_Init();
  /* ### BitsIO "rgb" init code ... */
